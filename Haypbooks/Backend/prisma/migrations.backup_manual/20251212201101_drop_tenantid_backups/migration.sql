...
DO $$ BEGIN
	IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name = 'Budget' AND column_name = 'tenantId') THEN
	...
	END IF;
	IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name = 'FixedAssetCategory' AND column_name = 'tenantId') THEN
...
DO $$ BEGIN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'Budget') THEN
		...
		ALTER TABLE public."Budget" DROP CONSTRAINT IF EXISTS "Budget_tenantId_not_null";
			IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='Budget' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'Employee') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='Employee' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'FixedAsset') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='FixedAsset' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'FixedAssetCategory') THEN
		...
		CREATE UNIQUE INDEX IF NOT EXISTS FixedAssetCategory_tenant_name_key_tenantid ON public."FixedAssetCategory" ("tenantId", name);
		ALTER TABLE public."FixedAssetCategory" DROP CONSTRAINT IF EXISTS "FixedAssetCategory_tenant_name_key";
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='FixedAssetCategory' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'PaySchedule') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='PaySchedule' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'Paycheck') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='Paycheck' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'PayrollRun') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='PayrollRun' AND column_name='tenantId_uuid_old') THEN
	...
	IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name = 'PayrollRunEmployee') THEN
		...
		IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='PayrollRunEmployee' AND column_name='tenantId_uuid_old') THEN
