    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-slate-800">Item Receipts</h2>
        </div>
        <button
          type="button"
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-slate-100">
            {transactions.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-4 py-12 text-center text-sm text-slate-400">No item receipts found.</td>
              </tr>
            ) : (
              transactions.map((tx) => {
