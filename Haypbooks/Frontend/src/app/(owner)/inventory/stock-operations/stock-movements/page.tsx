...
import { RefreshCw, PackageOpen, Search, ArrowLeftRight } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Track all inventory transaction activity</p>
        </div>
        <button
          type="button"
