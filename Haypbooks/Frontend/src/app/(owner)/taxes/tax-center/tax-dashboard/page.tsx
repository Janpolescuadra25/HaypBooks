    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-slate-800">Tax Dashboard</h2>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-100">
              {!sortedDeadlines.length ? (
                <tr>
                  <td colSpan={4} className="px-4 py-12 text-center text-sm text-slate-400">No calendar deadlines available</td>
                </tr>
              ) : (
                sortedDeadlines.map((deadline: any) => {
                  ...
                  return (
                    <tr key={`${deadline.formType}-${deadline.dueDate}`} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-slate-700">{deadline.description}</td>
