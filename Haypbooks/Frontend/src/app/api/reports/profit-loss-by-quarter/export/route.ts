...
export async function GET(req: Request) {
  ...
  rows.push([])
  rows.push(['Account', ...data.quarters.map(quarterLabel), 'Total'])
  ...
  const filename = buildCsvFilename('profit-loss-by-quarter', { asOfIso, tokens: [period], tokenPosition: 'before' })
