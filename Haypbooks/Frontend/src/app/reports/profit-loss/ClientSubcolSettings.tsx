...
export default function PLClientSubcolSettings({ current }: { current: Key[] }) {
  ...
  function onChange(next: string[]) {
    // Ensure 'curr' is always included
  ...
  router.replace((`/reports/profit-loss${params.size ? `?${params.toString()}` : ''}`) as any)
  }
