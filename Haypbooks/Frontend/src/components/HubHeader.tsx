...
export default function HubHeader() {
  ...
  // Hide header on the hub selection, central hub pages and the workspace selection page to keep the hub chrome minimal
  if (pathname.startsWith('/hub/selection') || pathname.startsWith('/hub') || pathname.startsWith('/workspace')) return null
