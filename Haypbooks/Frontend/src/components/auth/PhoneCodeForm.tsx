...
export default function PhoneCodeForm({ phone, onSuccess, onBack, enableAutoSubmit = true, verificationService }: { phone: string, onSuccess: () => void, onBack?: () => void, enableAutoSubmit?: boolean, verificationService?: any }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <p className="text-sm text-slate-600">We will send a 6-digit code to <strong>{masked || phone}</strong></p>
        <div className="mt-2">
