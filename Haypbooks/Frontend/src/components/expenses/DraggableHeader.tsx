...
export function DraggableHeader<TData, TValue>({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative flex items-center h-11 border-r border-slate-200 bg-muted/50 px-3 text-left align-middle font-bold uppercase tracking-tight text-muted-foreground last:border-r-0 hover:bg-muted transition-colors select-none",
