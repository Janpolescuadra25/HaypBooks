...
const SAMPLE: PerDiem[] = [
  { id: 'pd-001', perDiemNumber: 'PD-2026-001', employee: 'Patricia Mendoza', destination: 'Cebu City',   startDate: '2026-04-10', endDate: '2026-04-12', days: 3, dailyRate: 1500, total: 4500, status: 'SUBMITTED' },
  { id: 'pd-002', perDiemNumber: 'PD-2026-002', employee: 'Jerome Villanueva',destination: 'Davao City',  startDate: '2026-04-15', endDate: '2026-04-16', days: 2, dailyRate: 1500, total: 3000, status: 'DRAFT'     },
  { id: 'pd-003', perDiemNumber: 'PD-2026-003', employee: 'Aira Cruz',        destination: 'Iloilo City', startDate: '2026-03-20', endDate: '2026-03-22', days: 3, dailyRate: 1500, total: 4500, status: 'APPROVED'  },
]
...
export default function PerDiemPage() {
  ...
  const [rows]                          = useState<PerDiem[]>(SAMPLE)
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div><h1 className="text-2xl font-bold text-emerald-900">Per Diem</h1><p className="text-sm text-emerald-600/70 mt-0.5">{`${sorted.length} claims`}</p></div>
