  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div><h1 className="text-2xl font-bold text-emerald-900">Procurement Approvals</h1><p className="text-sm text-emerald-600/70 mt-0.5">{`${sorted.length} approvals`}</p></div>
