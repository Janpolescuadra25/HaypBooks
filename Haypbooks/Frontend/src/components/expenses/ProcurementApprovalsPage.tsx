...
import { Plus, Search, MoreVertical, Download, Filter, SlidersHorizontal, CheckSquare, Square, X, ArrowUpDown, Eye, Check, XCircle, RefreshCw } from 'lucide-react'
...
export default function ProcurementApprovalsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      ...
      <div className="mt-6">
        <ExpenseActivityWidget tableName="ProcurementApproval" entityLabel="Approvals" pageSize={8} />
      </div>
