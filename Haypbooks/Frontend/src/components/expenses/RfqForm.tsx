        ...
        <div className="mx-auto max-w-7xl px-4 py-2.5 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
              <div>
                <h1 className="text-lg font-bold tracking-tight text-slate-900">{mode === 'new' ? 'New RFQ' : 'Edit RFQ'}</h1>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                  <div>
                    <label htmlFor="rfqSubject" className="block text-sm font-semibold text-slate-900">Subject</label>
                    <input
                      id="rfqSubject"
                      value={subject}
                  ...
                  <div>
                    <label htmlFor="rfqClosingDate" className="block text-sm font-semibold text-slate-900">Closing Date</label>
                    <input
                      id="rfqClosingDate"
                      type="date"
                      value={closingDate}
                  ...
                  <div className="xl:col-span-2">
                    <label htmlFor="rfqDescription" className="block text-sm font-semibold text-slate-900">Description</label>
                    <textarea
                      id="rfqDescription"
                      value={description}
                  ...
                  <div className="xl:col-span-2">
                    <label htmlFor="rfqNotes" className="block text-sm font-semibold text-slate-900">Notes</label>
                    <textarea
                      id="rfqNotes"
                      value={notes}
                      ...
                      rows={3}
                      className="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 focus:border-emerald-400 focus:outline-none"
                      placeholder="Optional notes for vendors or internal use"
                    />
                  </div>
                </div>
              </section>
      ...
      <div className="sticky bottom-0 z-40 border-t border-slate-200 bg-white/95 backdrop-blur-sm px-4 py-4 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <button type="button" onClick={() => router.push('/expenses/procurement/rfq')} disabled={submitting} className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">Cancel</button>
            <button type="button" onClick={handleSave} disabled={submitting} className="inline-flex items-center gap-2 rounded-2xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50">
