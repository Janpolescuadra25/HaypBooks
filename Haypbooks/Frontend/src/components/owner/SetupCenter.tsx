...
const SETUP_PHASES: SetupPhase[] = [
  {
    ...
    tasks: [
      ...
      { id: 'bank', title: 'First Bank Account', description: 'Configure first bank account', path: '/banking/transactions', required: true },
  ...
  },
  {
    ...
    tasks: [
      { id: 'bank_feeds', title: 'Connect Bank Feeds', description: 'Enable bank connection and reconciliation', path: '/banking/bank-connections/connected-banks', required: true },
      { id: 'transaction_rules', title: 'Transaction Rules', description: 'Set auto-categorization rules for bank records', path: '/banking/transactions/rules' },
      { id: 'bank_reconciliation', title: 'Bank Reconciliation', description: 'Reconcile bank balances and transactions', path: '/banking/reconciliation/reconcile' },
      { id: 'payouts', title: 'Payout Accounts', description: 'Configure disbursement accounts', path: '/banking/payments/payment-runs' },
    ],
  },
  {
    id: 'phase_5',
    ...
    tasks: [
      ...
      { id: 'products', title: 'Products & Services', description: 'Define products/services for sales', path: '/sales/opportunities/products-services' },
      { id: 'prices', title: 'Pricing Rules', description: 'Review product pricing and discounts', path: '/sales/opportunities/products-services' },
