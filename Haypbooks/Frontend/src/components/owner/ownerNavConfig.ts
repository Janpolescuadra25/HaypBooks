    ...
    groups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              { title: 'Reconciliation Hub', path: '/banking-cash/reconciliation/reconciliation-hub' },
              { title: 'Reconcile', path: '/banking-cash/reconciliation/reconcile' },
              { title: 'History', path: '/banking-cash/reconciliation/history' },
          ...
          },
          {
            title: 'Accounts',
            items: [
              { title: 'Bank Accounts', path: '/banking-cash/accounts/bank-accounts' },
              { title: 'Credit Cards', path: '/banking-cash/accounts/credit-cards' },
              { title: 'Petty Cash', path: '/banking-cash/accounts/petty-cash' },
              { title: 'Clearing Accounts', path: '/banking-cash/accounts/clearing-accounts' },
            ],
          },
          {
            title: 'Management',
            items: [
              { title: 'Transaction Rules', path: '/banking-cash/management/transaction-rules' },
              { title: 'Recurring Transactions', path: '/banking-cash/management/recurring-transactions' },
            ],
          },
          {
            ...
            items: [
              ...
              { title: 'Cash Flow Projection', path: '/banking-cash/cash-management/cash-flow-projection' },
        ...
        items: [
          {
            ...
            items: [
              ...
              { title: 'Price Lists', path: '/sales/customers/price-lists' },
          ...
          },
          {
            title: 'Sales',
            items: [
              { title: 'Products & Services', path: '/sales/sales/products-services' },
              { title: 'Quotes', path: '/sales/sales/quotes' },
              { title: 'Sales Orders', path: '/sales/sales/sales-orders' },
            ],
          },
          {
            title: 'Billing',
            items: [
              ...
              { title: 'Subscriptions', path: '/sales/billing/subscriptions' },
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'Dunning', path: '/sales/collections/dunning' },
              { title: 'Write-Offs', path: '/sales/collections/write-offs' },
              { title: 'Refunds', path: '/sales/collections/refunds' },
            ],
          },
          {
            title: 'Revenue',
            items: [
              ...
              { title: 'Revenue Recognition', path: '/sales/revenue/revenue-recognition' },
              { title: 'Deferred Revenue', path: '/sales/revenue/deferred-revenue' },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            items: [
              ...
              { title: 'Purchase Requests', path: '/expenses/vendors/purchase-requests' },
              { title: 'Purchase Orders', path: '/expenses/vendors/purchase-orders' },
              { title: 'RFQ', path: '/expenses/vendors/rfq' },
              { title: 'Approvals', path: '/expenses/vendors/approvals' },
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'Reimbursements', path: '/expenses/expense-capture/reimbursements' },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            items: [
              ...
              { title: 'Bundles', path: '/inventory/setup/bundles' },
          ...
          },
          {
            title: 'Operations',
            items: [
              { title: 'Item Receipts', path: '/inventory/stock-operations/item-receipts' },
              { title: 'Stock Movements', path: '/inventory/stock-operations/stock-movements' },
              { title: 'Adjustments', path: '/inventory/stock-operations/inventory-adjustments' },
              { title: 'Transfers', path: '/inventory/stock-operations/transfers' },
            ],
          },
          {
            title: 'Warehousing',
            items: [
              { title: 'Warehouses', path: '/inventory/warehouses/warehouse-list' },
              { title: 'Bin Locations', path: '/inventory/warehousing/bin-locations' },
              { title: 'Zones', path: '/inventory/warehousing/stock-zones' },
            ],
          },
          {
            title: 'Control',
            items: [
              ...
              { title: 'Lot/Serial Tracking', path: '/inventory/control/lot-serial-tracking' },
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'Landed Costs', path: '/inventory/costing/landed-costs' },
              { title: 'Cost Adjustments', path: '/inventory/costing/cost-adjustments' },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            title: 'Execution',
            items: [
              { title: 'Project Tasks', path: '/projects/project-setup/project-tasks' },
              { title: 'Schedule', path: '/projects/planning/schedule' },
              { title: 'Resource Planning', path: '/projects/planning/resource-planning' },
              { title: 'Time & Expenses', path: '/projects/time-billing/timesheets' },
            ],
          },
          {
            title: 'Billing',
            items: [
              ...
              { title: 'WIP', path: '/projects/billing/work-in-progress' },
            ],
          },
          {
            title: 'Financials',
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'Time Approvals', path: '/time/review/time-approvals' },
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        title: 'Preferences',
        items: [
          { title: 'Accounting Preferences', path: '/settings/accounting-preferences/default-accounts' },
