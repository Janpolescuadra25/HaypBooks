      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            path: '/sales/revenue',
            tabs: [
              { label: 'Credit Notes',        value: 'credit-notes',  status: 'coming-soon' },
              { label: 'Revenue Recognition', value: 'recognition',   status: 'coming-soon' },
              { label: 'Deferred Revenue',    value: 'deferred',      status: 'coming-soon' },
            ],
          },
        ],
      },
