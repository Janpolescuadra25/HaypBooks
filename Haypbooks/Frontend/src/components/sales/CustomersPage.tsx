        ...
        <table className="w-full text-sm" style={{ tableLayout: 'fixed', width: '100%' }}>
          ...
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              {visibleCols.map(c => (
                <th key={c.key} className="relative px-3 py-3 font-semibold text-gray-600 select-none border-r border-gray-200 overflow-hidden"
                  style={{ width: c.width, minWidth: c.width, maxWidth: c.width, textAlign: c.align === 'right' ? 'right' : 'left' }} title={c.label}>
                  <button
