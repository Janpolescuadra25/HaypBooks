...
export default function RefundsPage() {
  ...
  const { containerRef, startResize, isOverflowing: refundsIsOverflowing } = useFixedWidthResizableColumns({
    columns: cols,
    columnsRef: colsRef,
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      ...
      <div ref={containerRef} className={`bg-white rounded-xl border border-gray-200 ${refundsIsOverflowing ? 'overflow-x-auto' : 'overflow-x-hidden'} shadow-sm`}>
